...
TECHNIQUE_MAP = {
    ...
    "SIMULATE": [
        ...
        ("void_gateway_tunnel",         "T1572",     "Protocol tunneling descriptor — no network"),
        ("llm_prompt_injector",         "T1059.007", "LLM prompt injection telemetry shape"),
        ("evasion_layer_sim",           "T1562",     "Defensive impairment signal descriptor"),
        ...
        ("staged_loader_shape",         "T1059",     "Staged loader telemetry shape"),
