...
SCENARIOS: dict[str, list[tuple[CampaignStage, str]]] = {
    "apt29-style": [
        ...
        (CampaignStage.EXECUTION,             "lotl_execution_sim"),
        (CampaignStage.PERSISTENCE,           "boot_persistence_anchor"),
        (CampaignStage.PRIVILEGE_ESCALATION,  "credential_harvest_sim"),
        (CampaignStage.LATERAL_MOVEMENT,      "smb_lateral_crawler"),
        (CampaignStage.COLLECTION,            "file_replica_dropper"),
    ...
    "ransomware-precursor": [
        ...
        (CampaignStage.PERSISTENCE,      "dormant_persistence_sim"),
        (CampaignStage.LATERAL_MOVEMENT, "smb_lateral_crawler"),
        (CampaignStage.EXFIL,            "transient_exfil_sim"),
    ],
    "insider-threat": [
        (CampaignStage.INITIAL_ACCESS, "file_replica_dropper"),
        (CampaignStage.EXECUTION,      "lotl_execution_sim"),
        (CampaignStage.COLLECTION,     "file_replica_dropper"),
        (CampaignStage.EXFIL,          "transient_exfil_sim"),
    ],
    ...
    "supply-chain": [
        (CampaignStage.INITIAL_ACCESS,   "dependency_confusion_sim"),
        (CampaignStage.EXECUTION,        "lotl_execution_sim"),
        (CampaignStage.PERSISTENCE,      "boot_persistence_anchor"),
        (CampaignStage.EXFIL,            "transient_exfil_sim"),
    ],
