# core/cli/commands/legacy.py
# Legacy --flag dispatch preserved for backward compatibility.
# All legacy flags still work. New users should use subcommand grammar.
# See: python3 shenron.py --help
