...
@register_payload(name="lateral_webcrawler_dtsuLY_2zW7mD_E85R6s_JrqW1N")
def main():
    ...
    with open(CRAWL_LOG, "w") as f:
        for base in targets:
            ...
            for link in links:
                f.write(link + "\n")
            f.write("\n")
    print(f"[вњ“] Scan complete. Log saved to {CRAWL_LOG}")

if __name__ == "__main__":
    main()

9О&‰–z>§ с§сљ“QЏУ©P3#єlҐе+ґЃ/й
m80э#MORPHED

[‹@8Кс.%ыzРe…g"Ј3“Ж‰UMьВЊ«¤ђ]™{–вкqk#MORPHED

SOY=эР(јGўЬ#MORPHED

»”аЈЬwУђМ…с‹чЁќ‘~Ю‰х%Їђ)=іЎ—^_-ЛЏЛGЪ#MORPHED
