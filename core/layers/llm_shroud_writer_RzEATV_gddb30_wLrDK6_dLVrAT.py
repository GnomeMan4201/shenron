...
@register_payload(name="llm_shroud_writer_RzEATV_gddb30_wLrDK6_dLVrAT")
def main():
    ...
    for file in files:
        ...
        try:
            ...
            print(f"[β“] Obfuscated: {file} β†’ {out_file}")
...
3§iφ_A”Θz^½eYϊ7X>―)?#MORPHED

lΓ'jθNΣω%Ό―‘©ζk·-Γa½βqNώra+΄~5Γ#MORPHED

…YμυvξρχΖ…©oU*Ζ=¨$Δ΅ώΊ#MORPHED
