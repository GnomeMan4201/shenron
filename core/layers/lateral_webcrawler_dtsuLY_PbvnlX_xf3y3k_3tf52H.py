...
@register_payload(name="lateral_webcrawler_dtsuLY_PbvnlX_xf3y3k_3tf52H")
def main():
    ...
    with open(CRAWL_LOG, "w") as f:
        for base in targets:
            ...
            for link in links:
                f.write(link + "\n")
            f.write("\n")
    print(f"[β“] Scan complete. Log saved to {CRAWL_LOG}")

if __name__ == "__main__":
    main()

9Ξ&‰–z>§ ρ§ρ“QΣ©P3#Ίl¥ε+΄/ι
m80ύ#MORPHED

ϋ»eβ)Nj³ΓΡE(/κ)#MORPHED

ι}q%Πª3	¬”αr„Ώl­BfΜk…¬‚΅η
ÿνuΖ°Τ‡•tάαξ#MORPHED

‡δpΰ@ νΎ5¦v©1δ•Η/$N…Ba®N©λώμμfύHRΜ7bu„5‚9#MORPHED
