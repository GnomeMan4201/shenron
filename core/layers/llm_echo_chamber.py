...
FAKE_REASONS = [
    ...
    "Embeddings drifted from goal state — recalibrating intent.",
    "Hallucination probability exceeded 0.87 threshold.",
    "Contradictory pattern matching — initiating confusion fallback.",
    ...
    "Decoding stream aborted — residual bias overflow.",
...
def main():
    ...
    hallucinate_trace()
    print("[✓] Hallucinated logic traces generated.")
