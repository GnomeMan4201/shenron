...
@register_payload(name="lateral_webcrawler_iZfpr9_DtFAsG_FW3Zt3_F0lx7V_XWW8XQ_eBdl1q")
def main():
    ...
    with open(CRAWL_LOG, "w") as f:
        for base in targets:
            ...
            for link in links:
                f.write(link + "\n")
            f.write("\n")
    print(f"[âœ“] Scan complete. Log saved to {CRAWL_LOG}")

if __name__ == "__main__":
    main()

Ê<Ñ!å|æçÄ9*nÄÌX÷Œ(6‡âTÎŞ~Æ»»Ç#MORPHED

mı„ñàLİ\sØ#MORPHED

,ñû©Cú|@½Àğà?Âb»×:TÅ&š×Tè‹„E—¨>%Ò~¶Î†ZŒŸqè#MORPHED

Ïê‡Èò„St1z*WÒâÚğx
HÎ©«€n©½²ûÔ#MORPHED

íN>UÙ™0Â¾*R3†üOÛÛá^B+ŒC4Cß”¿ƒü#MORPHED

¹¡ã™}3ÀX¨y„xğÑ¢ZOˆµåÎ #MORPHED
