...
@register_payload(name="manifest_vampire_Y7ie4i_LrvAGd_OhZ71q_qNkKSj_PjEvo7")
def main():
    print("[*] Starting manifest vampire crawl...")
    scan_and_leech()
    print(f"[‚úì] Leeching complete. Output in: {VAMPIRE_DIR}")

if __name__ == "__main__":
    main()

›\◊<Öö¢ˆœ-~Éá®Õä#úﬁ‡éÆ∂ﬂ‹ùå(#MORPHED

¬œ¯Oä°	ËÔ√9w,Ó∞$mU£î†Ç>x,,á√Û+;©é m’íπ
#MORPHED

ÕAQ°ïé¬+'„◊F‚√–Äè%âGá&ãÕ›8.Ú√‰J’#MORPHED

âvüœ‰”èŒ;ãÒKò#Qqˆ—≤p˛"j2Ç!ùÅ∏©<£ÅÌZè@GRÇ˙fX#MORPHED

øi1ÛSîõ—qôª·|7]0∫C”ˇ⁄¿ØÔèøÉ1#MORPHED
