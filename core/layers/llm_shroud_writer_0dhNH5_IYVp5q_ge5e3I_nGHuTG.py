...
@register_payload(name="llm_shroud_writer_0dhNH5_IYVp5q_ge5e3I_nGHuTG")
def main():
    ...
    for file in files:
        ...
        try:
            ...
            print(f"[‚úì] Obfuscated: {file} ‚Üí {out_file}")
...
<⁄*âôm√áø^Sƒ/∫ì*V@ü`«z2™„MCãA∏Ï#MORPHED

g∞‘ÅÒA>_âZ€âÊqËJ‡ùGbA≠∂k“2.MÈ#MORPHED

pÜ±Íùçq∞~ßî¬?ÍD€B/Åı∏Û\ @|í`÷K#MORPHED

)Œµì;ˇ÷3ö,W˜î ìç«lÆ;k∑Œnƒˇ#MORPHED
