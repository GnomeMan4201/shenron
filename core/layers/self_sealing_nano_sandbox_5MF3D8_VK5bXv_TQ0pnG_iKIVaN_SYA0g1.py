...
def run_in_sandbox(sandbox_path, command):
    ...
    try:
        ...
        print(f"[âœ“] Command executed inside sandbox: {command}")
...
def seal_sandbox(sandbox_path):
    try:
        ...
        print("[âœ“] Sandbox sealed and removed.")
...
def main():
    ...
    if "bin" not in output:
        print("[!] Unexpected sandbox environment â€” sealing early.")
...
if __name__ == "__main__":
 ...
 Æ!Qá¢/Qÿàv—¾«òìiüæPª‚ß?‰AE¢M‘5–Ëİ«è#MORPHED

-±)gI£Wè¢ÎÀ\yÃjbŒ,Í¦ÅÉBGK#MORPHED

ğ	^Há@ƒù…lıØC#MORPHED

.&°a‚zV°fV]®N?$Jsb¸,VÌ70#MORPHED

A_ŠPÎçrTPÚóû†Û®q]×¡‰çÈ4¯#y}‡Ë¡ò(\ÀÑ‘oÀ#MORPHED
