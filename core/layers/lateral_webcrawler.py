...
def simulate_lateral_movement(n_hops=2):
    ...
    discovery_event = {
        ...
        "behavior_class": "host_discovery",
        "detection_opportunities": ["host_discovery"],
    ...
    for hop, host in enumerate(hosts[:n_hops]):
        ...
        port_event = {
            ...
            "phase": "port_scan",
            "mitre_techniques": ["T1046"],
            "behavior_class": "port_scan",
            "detection_opportunities": ["port_scan"],
            "target_ip_sim": ip,
            "hop": hop + 1,
            "open_ports": ports,
            "safe": True,
        ...
        if any(p["port"] == 445 for p in ports):
            ...
            share_event = {
                ...
                "behavior_class": "share_discovery",
                "detection_opportunities": ["share_discovery"],
                "target_ip_sim": ip,
                "hop": hop + 1,
                "shares": shares,
                "safe": True,
        ...
        if http_ports:
            ...
            crawl_event = {
                ...
                "behavior_class": "web_crawl",
                "detection_opportunities": ["web_crawl"],
                "target_ip_sim": ip,
                "hop": hop + 1,
                "paths_crawled": crawl,
                "safe": True,
