...
def run_in_sandbox(sandbox_path, command):
    ...
    try:
        ...
        print(f"[β“] Command executed inside sandbox: {command}")
...
def seal_sandbox(sandbox_path):
    try:
        ...
        print("[β“] Sandbox sealed and removed.")
...
def main():
    ...
    if "bin" not in output:
        print("[!] Unexpected sandbox environment β€” sealing early.")
...
ά§jίξ._ΗWΡΠAtP§i#MORPHED

πx8ΗώhR4‚_=p[έ†χΖ©¶Ωvοβ²Μσ#MORPHED

έΙ_ρέ«λΥΝ'ΕυβZ|#MORPHED

΅ψ…Ϊϋ&`ϋ4‹Bª–aΣ=ώWΠ¥χήΉ#MORPHED

΄ΥμΪ2%	Oª>xπZ#MORPHED
