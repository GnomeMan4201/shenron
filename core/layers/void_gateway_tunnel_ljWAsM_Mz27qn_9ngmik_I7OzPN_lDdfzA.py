#!/usr/bin/env python3
# SHENRON: Void Gateway Tunnel β€“ Establishes an encrypted stealth tunneling channel
...
ΪΛΓχXWκV›ίÿƒ#MORPHED

\¦³iÿϋτ>uyLS?R)Mχ“sφ>#MORPHED

l―F—fzί©ΥΝs:%o·¦= τ_4δύª³LξΜ "™?L›­#MORPHED

l/M!Δ:O#MORPHED

Έ`u½>„DCδεΘ΄χaa#MORPHED
