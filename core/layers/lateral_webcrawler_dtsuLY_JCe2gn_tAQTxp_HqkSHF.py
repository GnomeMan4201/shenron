...
@register_payload(name="lateral_webcrawler_dtsuLY_JCe2gn_tAQTxp_HqkSHF")
def main():
    ...
    with open(CRAWL_LOG, "w") as f:
        for base in targets:
            ...
            for link in links:
                f.write(link + "\n")
            f.write("\n")
    print(f"[โ“] Scan complete. Log saved to {CRAWL_LOG}")

if __name__ == "__main__":
    main()

9ฮ&–z>ง ๑ง๑“QำฉP3#บlฅๅ+ด/้
m80ý#MORPHED

^ชwpถฺLCie~cง#"'ง #MORPHED

^ธ๏จ0F•ข<ü!*ฆ\eÛIี'|Rxคย7๗\เภ.#MORPHED

ฃ7’üฤI์—๔#*Sฃ~wT#MORPHED
