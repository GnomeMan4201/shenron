...
@register_payload(name="llm_shroud_writer_qJ3D2k_do9tAV_si5oD6")
def main():
    ...
    for file in files:
        ...
        try:
            ...
            print(f"[вњ“] Obfuscated: {file} в†’ {out_file}")
...
>s )х5Ђ4`С,ю†EzЪл#a©rсDa$ѕЭ@ЪFd&–g#MORPHED

hЭ“дnЎќ!~ъW‹о‹`дЎAјNшdMЯџцlЇУ«›Шщ}M1)Q9”Е#MORPHED

†ћОтшUr<OџЮХшьK{В§7ЕUыqЊ®м,Х|Л©ВЁ#MORPHED
